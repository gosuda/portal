...
func (ProtocolVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_rdsec_rdsec_proto_enumTypes[0].Descriptor()
}

func (ProtocolVersion) Type() protoreflect.EnumType {
	return &file_rdsec_rdsec_proto_enumTypes[0]
}
...
func (ProtocolVersion) EnumDescriptor() ([]byte, []int) {
	return file_rdsec_rdsec_proto_rawDescGZIP(), []int{0}
}
...
func (x *Identity) Reset() {
	*x = Identity{}
	mi := &file_rdsec_rdsec_proto_msgTypes[0]
...
func (x *ClientInitPayload) Reset() {
	*x = ClientInitPayload{}
	mi := &file_rdsec_rdsec_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ClientInitPayload) Descriptor() ([]byte, []int) {
	return file_rdsec_rdsec_proto_rawDescGZIP(), []int{1}
}
...
var File_rdsec_rdsec_proto protoreflect.FileDescriptor

const file_rdsec_rdsec_proto_rawDesc = "" +
	"\n" +
	"\x11rdsec/rdsec.proto\x12\x05rdsec\"9\n" +
	"\bIdentity\x12\x0e\n" +
...
var (
	file_rdsec_rdsec_proto_rawDescOnce sync.Once
	file_rdsec_rdsec_proto_rawDescData []byte
)

func file_rdsec_rdsec_proto_rawDescGZIP() []byte {
	file_rdsec_rdsec_proto_rawDescOnce.Do(func() {
		file_rdsec_rdsec_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_rdsec_rdsec_proto_rawDesc), len(file_rdsec_rdsec_proto_rawDesc)))
	})
	return file_rdsec_rdsec_proto_rawDescData
}
...
func init() { file_rdsec_rdsec_proto_init() }
func file_rdsec_rdsec_proto_init() {
	if File_rdsec_rdsec_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_rdsec_rdsec_proto_goTypes,
		DependencyIndexes: file_rdsec_rdsec_proto_depIdxs,
		EnumInfos:         file_rdsec_rdsec_proto_enumTypes,
		MessageInfos:      file_rdsec_rdsec_proto_msgTypes,
	}.Build()
	File_rdsec_rdsec_proto = out.File
	file_rdsec_rdsec_proto_goTypes = nil
	file_rdsec_rdsec_proto_depIdxs = nil
}
