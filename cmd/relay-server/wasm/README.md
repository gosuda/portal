...
WebAssembly SDK for RelayDNS with **mandatory End-to-End Encryption (E2EE) Proxy** functionality.
...
├── relaydns_wasm.js          # WASM JavaScript bindings
├── relaydns_wasm_bg.wasm     # WASM binary (465KB)
├── relaydns_wasm_sw.js       # Service Worker bindings
├── relaydns_wasm.d.ts        # TypeScript definitions
...
curl http://localhost:4017/pkg/relaydns_wasm.js
curl http://localhost:4017/pkg/relaydns_wasm_bg.wasm
