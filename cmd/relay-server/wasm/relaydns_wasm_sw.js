...
(function() {
    ...
    __exports.DataInterpreter = DataInterpreter;
    ...
    __exports.HttpAdapter = HttpAdapter;
    ...
    __exports.ProxyEngine = ProxyEngine;
    ...
    class RelayClient {
        ...
        constructor(server_url) {
            const ptr0 = passStringToWasm0(server_url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.relayclient_new(ptr0, len0);
            return ret;
        }
        /**
    ...
    __exports.RelayClient = RelayClient;
    ...
    __exports.WebSocketAdapter = WebSocketAdapter;
