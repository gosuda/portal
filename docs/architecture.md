...
- Relay runtime lives in `portal/` (server, routing, transports, ACME, keyless, auth, discovery, WireGuard overlay, policy).
...
- Relay discovery polling order is generated by `discovery.OLSManager`:
